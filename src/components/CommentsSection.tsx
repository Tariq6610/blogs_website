...
// in this interface every recipy is specified by their id as key and these key properties are array of objects where every object is a comment section with a name and comment text.
