...
const Hero = () => {
  return (
    <div className='flex justify-center items-center min-h-[450px] px-[16px] bg-[url("/hero-image.avif")] bg-no-repeat bg-cover bg-bottom mb-6 text-white bg-opacity-15'>
